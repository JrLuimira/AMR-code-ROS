...
class RobotBase:
    def __init__(self):
        ...
        self.base_footprint_frame = rospy.get_param('~base_footprint_frame', 'base_link')

        self.velocity_subscriber_ = rospy.Subscriber("/sub_vel", Twist, self.vel_callback)
        self.odom_publisher_ = rospy.Publisher("odom2", Odometry, queue_size=50)
    ...
    def vel_callback(self,twist):
        self.linear_velocity_x_ = twist.linear.x * self.linear_scale_x
