...
"""autogenerated by genpy from arlo_control_msgs/WheelsEncoders.msg. Do not edit."""
import codecs
import sys
...
class WheelsEncoders(genpy.Message):
...
int16 right_encoder"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2h().pack(_x.left_encoder, _x.right_encoder))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.left_encoder, _x.right_encoder,) = _get_struct_2h().unpack(str[start:end])
      return self
