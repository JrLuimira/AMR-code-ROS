...
if("TRUE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /home/luigi/amr/Walter_AMR/amr_ws/src/fiducials/aruco_detect)
  set(aruco_detect_DEVEL_PREFIX /home/luigi/amr/Walter_AMR/amr_ws/devel/.private/aruco_detect)
  ...
  set(aruco_detect_INSTALL_PREFIX /home/luigi/amr/Walter_AMR/amr_ws/install)
...
if(NOT "/home/luigi/amr/Walter_AMR/amr_ws/devel/.private/aruco_detect/include;/usr/include/opencv4 " STREQUAL " ")
  set(aruco_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/luigi/amr/Walter_AMR/amr_ws/devel/.private/aruco_detect/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luigi/amr/Walter_AMR/amr_ws/src/fiducials/aruco_detect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/luigi/amr/Walter_AMR/amr_ws/devel/.private/aruco_detect/lib;/home/luigi/amr/Walter_AMR/amr_ws/devel/lib;/opt/ros/noetic/lib)
