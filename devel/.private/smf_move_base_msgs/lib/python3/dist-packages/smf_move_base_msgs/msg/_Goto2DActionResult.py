...
"""autogenerated by genpy from smf_move_base_msgs/Goto2DActionResult.msg. Do not edit."""
import codecs
import sys
...
class Goto2DActionResult(genpy.Message):
  ...
  _type = "smf_move_base_msgs/Goto2DActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','smf_move_base_msgs/Goto2DResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = smf_move_base_msgs.msg.Goto2DResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = smf_move_base_msgs.msg.Goto2DResult()
