...
(defsystem "pedsim_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "FrozenAgent" :depends-on ("_package_FrozenAgent"))
    (:file "_package_FrozenAgent" :depends-on ("_package"))
    (:file "FrozenAgents" :depends-on ("_package_FrozenAgents"))
    (:file "_package_FrozenAgents" :depends-on ("_package"))
