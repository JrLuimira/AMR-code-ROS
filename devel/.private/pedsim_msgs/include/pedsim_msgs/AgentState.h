...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(TYPE_FROZEN)
  #undef TYPE_FROZEN
#endif
  ...
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> TYPE_FROZEN;
...
// constants requiring out of line definition
   ...
   template<typename ContainerAllocator> const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
      AgentState_<ContainerAllocator>::TYPE_FROZEN =
...
struct MD5Sum< ::pedsim_msgs::AgentState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x3a487fc374ec864eULL;
  static const uint64_t static_value2 = 0x6dcd8e0b70507ab2ULL;
};
