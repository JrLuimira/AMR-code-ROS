...
"""autogenerated by genpy from arlo_auto_docking/AutoDockAction.msg. Do not edit."""
import codecs
import sys
...
import arlo_auto_docking.msg
import genpy
import std_msgs.msg

class AutoDockAction(genpy.Message):
  _md5sum = "67e772c38f6d3d0bd548a0f9d9391f48"
  _type = "arlo_auto_docking/AutoDockAction"
...
"""
  ...
  _slot_types = ['arlo_auto_docking/AutoDockActionGoal','arlo_auto_docking/AutoDockActionResult','arlo_auto_docking/AutoDockActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = arlo_auto_docking.msg.AutoDockActionGoal()
      if self.action_result is None:
        self.action_result = arlo_auto_docking.msg.AutoDockActionResult()
      if self.action_feedback is None:
        self.action_feedback = arlo_auto_docking.msg.AutoDockActionFeedback()
    else:
      self.action_goal = arlo_auto_docking.msg.AutoDockActionGoal()
      self.action_result = arlo_auto_docking.msg.AutoDockActionResult()
      self.action_feedback = arlo_auto_docking.msg.AutoDockActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.request
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.request = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.request = str[start:end]
      _x = self
      start = end
      end += 12
