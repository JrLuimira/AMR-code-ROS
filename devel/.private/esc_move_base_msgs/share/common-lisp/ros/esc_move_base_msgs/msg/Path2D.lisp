...
(cl:defmethod cl:initialize-instance :after ((m <Path2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name esc_move_base_msgs-msg:<Path2D> is deprecated: use esc_move_base_msgs-msg:Path2D instead.")))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader esc_move_base_msgs-msg:waypoints-val is deprecated.  Use esc_move_base_msgs-msg:waypoints instead.")
  (waypoints m))
