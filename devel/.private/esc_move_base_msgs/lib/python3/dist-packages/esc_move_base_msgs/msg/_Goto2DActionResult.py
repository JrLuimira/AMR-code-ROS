...
"""autogenerated by genpy from esc_move_base_msgs/Goto2DActionResult.msg. Do not edit."""
import codecs
import sys
...
class Goto2DActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "esc_move_base_msgs/Goto2DActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','esc_move_base_msgs/Goto2DResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Goto2DActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = esc_move_base_msgs.msg.Goto2DResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = esc_move_base_msgs.msg.Goto2DResult()
