...
"""autogenerated by genpy from esc_move_base_msgs/Goto2DActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class Goto2DActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "esc_move_base_msgs/Goto2DActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','esc_move_base_msgs/Goto2DFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Goto2DActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = esc_move_base_msgs.msg.Goto2DFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = esc_move_base_msgs.msg.Goto2DFeedback()
